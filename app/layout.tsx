...
export const metadata: Metadata = {
  ...
  description:
    'Run service, billing, online orders, and inventory with Digirestro—POS and back-office tools built for restaurants. Trusted by fleet of restaurant teams all over the world.',
  icons: {
    icon: [
      {
